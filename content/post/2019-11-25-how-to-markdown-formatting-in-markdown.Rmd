...
I've opted to start with *.rmd* to construct my posts because 

1.  I like that my workflow can be done entirely within RStudio, and  
2.  the amazing addition of the `reticulate::` library provides flexibility for writing in both python and R seamlessly

Since this is coming from a complete noob, I'll keep the first post simple. Today's post will deal with Pandoc's markdown syntax.

### Pandoc Markdown: A quick overview

I've put together a quick reference table for text formating in markdown. Will add on to it as I learn more, but for now this is purely taken from the [cheatsheet](https://rstudio.com/wp-content/uploads/2016/03/rmarkdown-cheatsheet-2.0.pdf) put together by RStudio.
