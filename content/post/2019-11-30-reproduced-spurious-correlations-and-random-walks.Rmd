...
Looking at Figure \@ref(fig:combined), it's clear that the random walk processes are much more erratic than the AR processes ($\phi$ = 0.5). This phenomonon is also called "non-stationarity" in statistical gobbledygook.
