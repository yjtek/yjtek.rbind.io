...
### Discussion
I think it's ridiculously intuitive to simply say 50%, similar to the [Monty Hall Problem](https://en.wikipedia.org/wiki/Monty_Hall_problem). This answer comes from our intuition that children's genders are essentially a coin flip (cclearly not a biologist). Having a son doesn't, *shouldn't* increase your odds of subsequently having either a son or a daughter, right?
